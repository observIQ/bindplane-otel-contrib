...
import (
	...
	"github.com/observiq/bindplane-otel-contrib/receiver/googlecloudpubsubreceiver/internal/metadata"
)
...
// StreamHandler runs a Pub/Sub StreamingPull stream: it pulls messages, hands
// them to a callback, and batches acknowledgements and nacks back onto the stream.
...
// NewHandler creates a StreamHandler and initializes its first stream.
func NewHandler(
	ctx context.Context,
	settings receiver.Settings,
	telemetryBuilder *metadata.TelemetryBuilder,
...
// CancelNow stops the handler, flushes any pending acknowledgements, and cancels the stream context.
...
// Wait blocks until the stream goroutines have finished.
