...
// SetAwsNeuronDeviceType sets provided value as "aws.neuron.device.type" attribute.
func (rb *ResourceBuilder) SetAwsNeuronDeviceType(val string) {
	if rb.config.AwsNeuronDeviceType.Enabled {
		rb.res.Attributes().PutStr("aws.neuron.device.type", val)
	}
}

// SetAwsNeuronNeuroncoreVersion sets provided value as "aws.neuron.neuroncore.version" attribute.
func (rb *ResourceBuilder) SetAwsNeuronNeuroncoreVersion(val string) {
	if rb.config.AwsNeuronNeuroncoreVersion.Enabled {
		rb.res.Attributes().PutStr("aws.neuron.neuroncore.version", val)
	}
}
