...
| `start_time_value`     | string |         | `false`  | Value for the start time: `"now"` sends the current time, or a fixed timestamp in the configured format (e.g., `"2025-01-01T00:00:00Z"` or `"1704067200"` for epoch). For timestamp pagination, this is the initial start value       |
...
| `end_time_value`       | string | `now`   | `false`  | Value for the end time: `"now"` (default) sends the current time, or a fixed timestamp in the configured format                                                                                                                       |
