...
require (
	github.com/observiq/bindplane-otel-contrib/pkg/counter v1.12.0
	github.com/observiq/bindplane-otel-contrib/pkg/expr v1.12.0
	github.com/observiq/bindplane-otel-contrib/receiver/routereceiver v1.12.0
