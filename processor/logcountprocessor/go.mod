...
require (
	github.com/observiq/bindplane-otel-contrib/pkg/counter v1.13.0
	github.com/observiq/bindplane-otel-contrib/pkg/expr v1.13.0
	github.com/observiq/bindplane-otel-contrib/receiver/routereceiver v1.13.0
