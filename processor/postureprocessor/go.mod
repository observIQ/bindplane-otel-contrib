module github.com/observiq/bindplane-otel-contrib/processor/postureprocessor

go 1.26.4

require (
	github.com/observiq/bindplane-otel-contrib/internal/posture v1.8.0
	github.com/observiq/bindplane-otel-contrib/pkg/expr v1.8.0
...
replace github.com/observiq/bindplane-otel-contrib/internal/posture => ../../internal/posture
