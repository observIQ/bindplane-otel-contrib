module github.com/observiq/bindplane-otel-contrib/extension/encoding/textencodingextension
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/xstreamencoding v0.159.0
