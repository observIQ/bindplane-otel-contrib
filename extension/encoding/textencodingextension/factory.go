...
import (
	...
	"github.com/observiq/bindplane-otel-contrib/extension/encoding/textencodingextension/internal/metadata"
)

// NewFactory creates a factory for the text encoding extension.
