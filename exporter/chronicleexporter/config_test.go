...
func TestConfigValidate(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedErr: "invalid http_version",
		},
		{
			desc: "Negative max_idle_conns",
			config: &Config{
				Endpoint:                  "myendpoint.com",
				CredsFilePath:             "/path/to/creds_file",
				LogType:                   "log_type_example",
			...
			expectedErr: "max_idle_conns must not be negative",
		},
		{
			desc: "Negative max_idle_conns_per_host",
			config: &Config{
				Endpoint:                  "myendpoint.com",
				CredsFilePath:             "/path/to/creds_file",
				LogType:                   "log_type_example",
