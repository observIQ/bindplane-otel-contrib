...
func TestNewHTTPTransport(t *testing.T) {
	t.Run("default config negotiates HTTP/2", func(t *testing.T) {
		// createDefaultConfig sets http_version "2" and the idle-conn defaults.
	...
	t.Run("empty http_version stays on the HTTP/2 default", func(t *testing.T) {
