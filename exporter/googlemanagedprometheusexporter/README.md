...
[Google Managed Prometheus Exporter](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.159.0/exporter/googlemanagedprometheusexporter), with additional configuration options.
...
| `sending_queue`    | object  |                  | `false`  | Determines how telemetry data is buffered before exporting. See the documentation for the [exporter helper](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.159.0/exporter/exporterhelper/README.md) for more information. |
