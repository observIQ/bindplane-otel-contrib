...
[Google Cloud Exporter](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.154.0/exporter/googlecloudexporter), with additional processors built in to streamline configuration.
...
| `batch`            |                  | `false`  | The config of the exporter's [batch processor](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.154.0/processor/batchprocessor).                                                            |
