...
require (
	github.com/observiq/bindplane-otel-contrib/internal/exporterutils v1.8.0
	...
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.154.0
