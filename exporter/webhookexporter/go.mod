...
require (
	github.com/observiq/bindplane-otel-contrib/internal/exporterutils v1.11.0
	...
	go.opentelemetry.io/collector/exporter/exporterhelper/xexporterhelper v0.157.0
